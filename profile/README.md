...
| Repo | Domain | Status |
|------|--------|--------|
| [sandx-er](https://github.com/sandxlab/sandx-er) | Entity Resolution — duplicate detection, record linkage, probabilistic clustering | Phase 1 |
| [sandx-embed](https://github.com/sandxlab/sandx-embed) | Embedding & vector similarity — shared ANN infrastructure | Phase 1 |
| [sandx-graph](https://github.com/sandxlab/sandx-graph) | Graph intelligence — knowledge graphs, neighborhood consensus | Phase 1 |
| [sandx-compute](https://github.com/sandxlab/sandx-compute) | Distributed compute — GPU orchestration, consensus-aware scheduling | Phase 1 |
...
[sandx.io](https://sandx.io) &nbsp;·&nbsp; research@sandx.io
